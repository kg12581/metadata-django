...
urlpatterns = [
    ...
    path("flink-sync/auto-repair/", views.flink_sync_auto_repair, name="flink-sync-auto-repair"),
    path("flink-sync/config/save/", views.flink_sync_config_save, name="flink-sync-config-save"),
